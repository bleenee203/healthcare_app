...
class WaterMonthChart<T extends ChartPoint> extends StatefulWidget {
  const WaterMonthChart({super.key, required this.points});
  final List<T> points;

  @override
  State<WaterMonthChart<T>> createState() => _WaterMonthChartState<T>();
}

class _WaterMonthChartState<T extends ChartPoint>
    extends State<WaterMonthChart<T>> {
